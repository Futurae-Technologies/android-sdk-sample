...
import com.futurae.demoapp.accountsrestoration.AccountsRestorationFlow
...
import com.futurae.demoapp.lock.LockScreenConfiguration
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(route = FuturaeDemoDestinations.SPLASH_ROUTE.route) {
                ...
                SplashScreenRoute(
                    checkForMigratableAccounts = migrationViewModel::checkForMigratableAccounts,
                ) {
