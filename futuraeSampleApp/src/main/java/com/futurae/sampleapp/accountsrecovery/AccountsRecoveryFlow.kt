package com.futurae.sampleapp.accountsrecovery
...
import com.futurae.sampleapp.accountsrecovery.arch.AccountsRecoveryFlowViewModel
...
@Composable
fun AccountsRecoveryFlow(
    pinProviderViewModel: PinProviderViewModel,
    isPinProtected: Boolean,
    navController: NavController
) {
    val accountsRestorationViewModel: AccountsRecoveryFlowViewModel = viewModel(
        factory = AccountsRecoveryFlowViewModel.provideFactory(isPinProtected)
    )
