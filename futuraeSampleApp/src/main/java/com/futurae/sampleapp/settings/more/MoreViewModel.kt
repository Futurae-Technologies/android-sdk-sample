package com.futurae.sampleapp.settings.more
...
import com.futurae.sampleapp.navigation.NavigationArguments
...
import com.futurae.sampleapp.ui.shared.elements.alertdialog.FuturaeAlertDialogWithFilledButtonsUIState
                ...
                actionCallback = {
                    viewModelScope.launch {
                        _navigationEvent.emit(
                            FuturaeSampleDestinations.SETTINGS_ROUTE.route to false
                        )
                    }
                }
            ),
